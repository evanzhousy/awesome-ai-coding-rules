...
1. [`doc/harness/observability-rules.md`](../../harness/observability-rules.md) — P0/P1, destinations, `channel`, structured diagnosis fields, what is error vs info.
