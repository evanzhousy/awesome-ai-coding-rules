...
| Landing | `ops/landingpage/posthog-research.md` | Summarizing live landing traffic, acquisition, content engagement, CTA intent, repeat behavior, replay, heatmaps, performance, and tracking quality. |
