...
Active backlog is not empty. Start every real run with [Active fix verification backlog](#active-fix-verification-backlog); current unconfirmed rows remain Contract Rank direct snapshot/server fallback verification, Netlify missing-asset 404 handling, and TradingView duplicate raw vendor invalid-symbol suppression. 2026-07-08 rerun resolved Better Stack `WebFullStack-Errors` to application `2412994` and `WebFullStack-Info` to source `2357910`, and used PostHog project `300646` (`app.tradingflow.com`). Netlify asset probes for `/assets/gamma-exposure-screener.lazy-DI28ZLQ0.js`, `/assets/index-D5u4BulH.js`, `/assets/cookbooks.index-GFu0Bycw.js`, and `/assets/contract-rank.lazy-HJ_C0EY8.js` returned `404 text/html`, so routing is still deployed; do not archive the Netlify row because PostHog issue `019d2051-6a33-7b10-bb1e-54fa08bb3be7` still had 27 occurrences / 5 users / 16 sessions and Better Stack pattern `2403c9ba5deee2af387834e95461cfb32b9b5080b21d6f307b2f09bb09e71f21` still showed `network error` = 23 in `-24h`. The live CF snapshot endpoint returned valid `contract_rank_snapshot_compact_v9` shape (`d=2026-07-08`, `rc=296622`, `rc == r.length`, first tuple length `19`, valid `u`/`g` maps, 37.8 MB payload); old unsupported-payload/type-repair PostHog issues and Better Stack patterns were quiet, but do not archive the Contract Rank row because Better Stack Info still showed `contractFlowRank.snapshot` P1 recovered fallbacks (5 meta, 2 snapshot) plus 1 P0 `Failed to fetch Contract-level analysis snapshot`. TradingView NDX alias canonicalization and paired diagnostics were confirmed and archived on 2026-07-08: old PostHog issue `019f1b9d-898d-7cf1-8495-26f0df9b9a6a` had 0 sampled events, `019f1f0c-2a0f-7220-ba50-58e306f540f3` was not found in the current project, old Better Stack patterns `aa7332f87002488125e24c84372c7b27bb2989e31c94d2daf815b70f29d64599` / `bb0f6afe12034784f3dd15895acb0c584699730a2fbf1dc97219674185b069a2` were absent, and current TradingView Info rows no longer contained `NASDAQ:NDXP` while carrying non-empty `configuredSymbolMappings`. Current PostHog issue `019f3430-50f2-7201-bc2c-eaa20b6744a0` plus Better Stack patterns `002542d631afc57ddc5d8034f2a34eb92e307ed39bb9b4b810fa091f69827999` / `904676ed82ffa77159cb99b64bc737ecd6063e8021d7cdb6a7004bbc402ebc1c` are a separate third-party valid-symbol ticker-tape cluster; webapp commit `453548da2` now suppresses the duplicate raw browser event after structured reporting and parses `thirdPartyReportedSymbol` when the vendor message includes one. Verify this row after deploy.
